...
## ⚙️ How It Works
- User selects an image using GUI
- Image is resized and normalized
- Trained model processes the image
- Output breed is predicted with confidence score
- Result is displayed in the application window
